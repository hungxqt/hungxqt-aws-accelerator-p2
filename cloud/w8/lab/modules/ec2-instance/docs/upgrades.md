...
This wrapper is pinned to 	erraform-aws-modules/ec2-instance/aws version $Version. Upgrades are manual by design so consuming projects get reproducible behavior until this shared wrapper is intentionally changed.
