...
Only create public subnets when the project needs internet-facing resources such as ALB, NAT Gateway, or bastion-style access. Keep application instances in private subnets where possible.
