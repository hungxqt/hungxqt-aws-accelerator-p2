...
variable "github_actions_repository" {
  description = "GitHub owner/repository allowed to assume the CI secrets role."
  type        = string
  default     = "hungxqt/test-argocd"
}

variable "github_actions_branch" {
  description = "GitHub branch allowed to assume the CI secrets role for image signing."
  type        = string
  default     = "main"
}
