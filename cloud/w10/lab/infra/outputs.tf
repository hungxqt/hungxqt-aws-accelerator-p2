...
output "github_actions_cosign_role_arn" {
  description = "IAM role ARN GitHub Actions assumes to read Cosign signing secrets."
  value       = aws_iam_role.github_actions_cosign_secrets.arn
}
